...
public class User {
	...
	public static void main(String[] args) throws AccountException
	{
		while (true) 
		{
			...
			case 1:
				...
				addAccount(scanner, bean, service);
			...
			case 2:
				...
				showBalance(scanner, bean, service);
				break;
			...
			case 5:
				...
				transferFund(scanner, service);
				break;

			case 6:
				System.out.print("\n==========================\n Print Transactions\n==========================\n");
				
				printTransaction(scanner, service);
				break;
	 ...
	 * @param service
	 */
	private static void printTransaction(Scanner scanner, CustomerServiceImp service) {
		long accountNumber;
		int pin;
	 ...
	 */
	private static void transferFund(Scanner scanner, CustomerServiceImp service) throws AccountException {
		int pin;
		System.out.print("\nEnter your Account Number: ");
	 ...
	 * @throws AccountException
	 */
	private static void withdraw(Scanner scanner, CustomerServiceImp service) throws AccountException {
		long accountNumber;
		int pin;
		System.out.print("\nEnter your Account Number: ");
		accountNumber = scanner.nextLong();
	 ...
	 * @throws AccountException
	 */
	private static void deposit(Scanner scanner, CustomerServiceImp service) throws AccountException {
		long accountNumber;
		int pin;
		System.out.print("\nEnter your Account Number: ");
		accountNumber = scanner.nextLong();
	 ...
	 * @throws AccountException
	 */
	private static void showBalance(Scanner scanner, Customer bean, CustomerServiceImp service)
			throws AccountException {
		long accountNumber;
		int pin;
		System.out.print("\nEnter your Account number : ");
		...
		Double balance=service.showBalance(accountNumber, pin);
		if(balance != null)
	 ...
	 * @throws AccountException
	 */
	private static void addAccount(Scanner scanner, Customer bean, CustomerServiceImp service) throws AccountException {
		long accountNumber;
		int pin;
		boolean temp=false;
